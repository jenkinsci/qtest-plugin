...
The up to date release notes can be found here: [qTest Jenkins Plugin Release Notes](https://documentation.tricentis.com/qtest/od/en/content/integrations/jenkins_and_bamboo_integration.htm)
